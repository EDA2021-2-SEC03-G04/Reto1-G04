...
def Print_nacionalidad_obras(lista):
    ...
    for x in range(1, 11):
        elemento = lt.getElement(lista, x)
        print(str(x) + ') ' + elemento["lugar"] + " con " + str(elemento["cantidad"]) + " artistas")
    ...
    for x in range(5):
        ...
        print(str(x+1) + ')' + "La obra de titulo " + obra["titulo"] + " De artstas " + obra["artistas"] + " Hecha en " + str(obra["fecha"]) + " Con el medio " + obra["medio"] + "Con dimensiones" + obra["dimenciones"])
...
def printObrasNuevaEX(lista):
    ...
    for x in range(2 ,7):
        ...
        print(str(x-1) + ') ' + " La obra de titulo " + str(obra["titulo"]) + " hecha por " + obra["nombre"] + " Hecha en " + str(obra["fecha"]) + " Con el medio " + obra["medio"] + " Con dimensiones " + str(obra["dimenciones"]))
    ...
    for x in range(lt.size(lista) - 5 ,lt.size(lista)):
        obra = lt.getElement(lista, x)
        print(str(pp) + ') ' +" La obra de titulo " + str(obra["titulo"]) + " hecha por " + obra["nombre"] + " Hecha en " + str(obra["fecha"]) + " Con el medio " + obra["medio"] + " Con dimensiones " + str(obra["dimenciones"]))
        pp+=1
